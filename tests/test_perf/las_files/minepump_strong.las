...
:- head(antecedent_exception(_,_,_)), body(holds_at_eventually(_,V1,V2,_)), V1 = V2.
:- head(antecedent_exception(_,_,_)), body(not_holds_at_eventually(_,V1,V2,_)), V1 = V2.
:- body(holds_at_eventually(_,_,V1,_)), body(holds_at_eventually(_,_,V2,_)), V1 != V2.
:- head(antecedent_exception(assumption2_1,V1,V2)), body(holds_at_eventually(_,_,_,_)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(not_holds_at_eventually(_,_,_,_)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(not_holds_at(highwater,V1,V2)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(not_holds_at(methane,V1,V2)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(holds_at(pump,V1,V2)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(holds_at_prev(highwater,V1,V2)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(holds_at_prev(methane,V1,V2)).
:- head(antecedent_exception(assumption2_1,V1,V2)), body(holds_at_prev(pump,V1,V2)).
").
...
antecedent_holds(assumption2_1,T1,S):-
	trace(S),
	timepoint(T1,S),
	not antecedent_exception(assumption2_1,T1,S).
